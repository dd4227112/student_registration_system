<?php include('header.php');?>
            <h4 class="text-center content-heading text-gray-900 mb-4">Boarding Students- <?php echo $current_year;?> Academic year</h4>
...
<script>
  $(document).ready(function(){
    ...
    $('.closebtn').on('click', function(){
      ...
      $('.editbtn').hide();
      $('.edit_user').hide();
      $('h4').text("Boarding Students- "+currentyear+" Academic year");
